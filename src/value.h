...
#define lisplay_make_cfunc(cxt, name, required, optional, func) (lisplay_make_root_cfunc((cxt), NULL, (name), (required), (optional), (func)))
#define lisplay_make_lfunc(cxt, paramc, params, env, body) (lisplay_make_root_lfunc((cxt), NULL, (paramc), (params), (env), (body)))
